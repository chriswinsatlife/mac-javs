...
export async function getInterviewTranscript(slug) {
...
const interviews = [
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        start: 825,
        title: 'Multiverse Realities: How Every Choice Spreads Across Infinite Worlds',
      },
      ...
      {
        start: 2140,
        title: "Dr. Grayson's Theory of Quantum Nirvana: Achieving Free Will Across Universes",
      },
      {
        start: 2475,
        title: 'How to Hack the Multiverse: Practical Tips for Quantum Alignment',
      },
      {
        start: 2845,
        title: 'Lightning Round: Favorite Thought Experiments, Books, and Routines',
      },
      {
        start: 3130,
  ...
  },
  {
    ...
    video: {
      duration: 2940,
      thumbnail: 'https://assets.tailwindcss.com/templates/compass/sophia-reid-video-thumbnail.png',
  ...
  },
  {
    ...
    video: {
      duration: 3630,
      thumbnail: 'https://assets.tailwindcss.com/templates/compass/mick-larson-video-thumbnail.png',
