...
export async function getLesson(slug) {
  let module = lessons.find(({ lessons }) => lessons.some(({ id }) => id === slug))
...
const lessons = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: "Failures weren't freely chosen but were inevitable given your circumstances.",
        video: null,
      },
      {
        id: 'values-and-goals',
  ...
  },
  {
    ...
    description: 'Experience the sensation of choice without the burden of true responsibility.',
    lessons: [
      {
      ...
      },
      {
        ...
        description: "You can't be paralysed by choices you don't actually have.",
        video: null,
      },
      {
        id: 'path-of-least-resistance',
        title: 'Perceiving the Path of Least Resistance',
        description: 'Recognizing which direction requires the least psychological struggle.',
        video: {
          duration: 1147,
          thumbnail:
            'https://assets.tailwindcss.com/templates/compass/lesson-video-thumbnail-01.png',
      ...
      },
      {
        ...
        description: "Accepting that whatever path you choose has no bearing on where you'll go.",
        video: {
          duration: 1423,
          thumbnail:
  ...
  },
  {
    ...
    description: 'Techniques for aligning with your inevitable trajectory while avoiding nihilism.',
    lessons: [
      {
        id: 'widening-field-of-view',
        title: 'Widening Your Field of View',
        description: "The universe can be cruel and it's important to see that coming.",
        video: {
          duration: 934,
          thumbnail:
            'https://assets.tailwindcss.com/templates/compass/lesson-video-thumbnail-02.png',
      ...
      },
      {
        ...
        description: "When actions are beyond one's control, punishment is illogical.",
        video: null,
      },
      {
        id: 'anxiety-messages',
      ...
      },
      {
        ...
        description: 'Who you think you are has been assigned to you by circumstance.',
        video: null,
      },
    ],
  },
  {
    ...
    description: "How to be content with the inconsequential destiny you've been given.",
    lessons: [
      {
        id: 'reframing-achievement',
        title: 'Reframing Achievement and Failure',
        description: 'Pride and regret are just psychological coping mechanisms.',
        video: null,
      },
      {
      ...
      },
      {
        ...
        description: 'Recognize the broader system that produced your achievement.',
        video: {
          duration: 967,
          thumbnail:
            'https://assets.tailwindcss.com/templates/compass/lesson-video-thumbnail-04.png',
