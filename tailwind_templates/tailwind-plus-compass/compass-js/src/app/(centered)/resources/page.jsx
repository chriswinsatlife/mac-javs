  ...
  return (
    ...
    >
      ...
      <p className="mt-6 max-w-xl text-base/7 text-gray-600 dark:text-gray-400">
        A collection of resources that can help you navigate uncertainty and make choices aligned
      ...
      <div className="mt-16 space-y-16">
        ...
        <PageSection title={<h2>Books</h2>}>
          <p className="text-sm/8 text-gray-600 dark:text-gray-400">
            A carefully curated collection of books that explore the intersection of choice,
