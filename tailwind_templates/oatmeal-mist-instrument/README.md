...
This folder contains the theme version with Instrument Serif and the "mist" or turquoise color scheme.

The available typefaces for this theme are Familjen (sans), Instrument (serif), and Mona (sans).

The available color schemes are Mauve, Mist, Olive, and Taupe.

The other versions can be downloaded from the Tailwind site, or the color scheme and typefaces can simply be changed in the stylesheets within this folder.
