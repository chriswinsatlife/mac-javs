# Looks and Themes in Mermaid JS

## Basic Implementation

In order to modify your diagrams, you can use the metadata section of your diagram. This is easy. Just add the following YAML frontmattercode to the top of your diagram code or markdown document.
