---
title: "The Content Writing Guide: How to Write Blog Posts That Readers Care About - Animalz"
description: "Here's the nuts-and-bolts process we follow to write irresistible blog posts - from idea to outline to conclusion."
author: ""
url: "https://www.animalz.co/blog/content-writing-guide"
date: ""
...
[Build an idea farm](https://www.animalz.co/blog/idea-farm) — a single document that collects every nascent thought, opinion, or idea you have during the day. It could be a Google doc, a Trello board, or any database that stores raw "seeds." These are thoughts from sales conversations, unexpected customer feedback, a colleague's point in Slack, or a quote from a book you're reading.
...
Good ideas need depth and perspective. You might find that perspective from academic methods like [keyword research](https://www.animalz.co/blog/keyword-research) and audience analysis, or simply by getting input from a peer. Colleagues help identify your most compelling ideas, ask questions to further your thinking, and add their unique experience and perspective into the mix.
...
The next step is to consider **how** you frame the idea. A good topic becomes a great post when you [frame it with the right angle](https://www.animalz.co/blog/find-the-right-angle).
...
Unique angles matter for SEO, too. When every top-ranking article says roughly the same thing, you stand out by adding something new to the conversation. Google calls this [information gain](https://www.animalz.co/blog/information-gain), and it's how you compete when AI can summarize the basics instantly.

**There's a simple exercise to turn your validated ideas into unique angles:**

1. List 20–30 truisms about your industry ("retention is king," "hire for culture," "build things people want").

2. Grab a partner to bounce ideas off of, and record the session. ChatGPT will work as a partner, too.

3. For each truism, ask: Do I have reason to believe the opposite, or can I imagine edge cases where this doesn't hold?

4. Skip liberally — you won't have much to say for most items, and that's fine.

5. The one or two truisms where you find yourself passionate about reversing convention are your angles.

Another way to bring a unique angle: [Interview subject matter experts](https://www.animalz.co/blog/how-to-interview-someone-for-an-article). Even great writers don't have deep expertise in every topic they cover. Experts add credibility and fresh insights that transform generic advice into specific, actionable guidance.
...
[Writing a blog post outline](https://www.animalz.co/blog/how-to-write-a-blog-post-outline) is like planning a road trip. You don't pick stops before you choose your destination. Same with outlines — you can't build one before you figure out where it's leading.
...
Almost done with the outline. You just need to verify it against the [MECE framework](https://www.animalz.co/blog/mece-mutually-exclusive-collectively-exhaustive).
...
You can [write your introduction](https://www.animalz.co/blog/how-to-write-an-introduction) before or after you draft the main body — either way, you'll refine it later. The chances you landed on a catchy hook and a sleek thesis on your first pass are low.
...
Don't just present information; lead readers through the reasoning process so they arrive at your conclusion themselves. Use the [thesis-antithesis-synthesis structure](https://www.animalz.co/blog/thesis-antithesis-synthesis/): present the status quo (thesis **\***), articulate the problems with it (antithesis), then share your better solution (synthesis).
...
AI can help you draft faster, but [never let it fill your blank page](https://www.animalz.co/blog/blank-page-syndrome-and-generative-ai). Start with your own thinking — an outline, a messy paragraph, a stream of thoughts. Use AI to get unstuck, generate variations, or connect disjointed sections, not to do your thinking for you.

## Step 5: Revise Your Draft

First drafts are for you. Published drafts are for your reader.

That initial draft is a [thinking tool](https://www.animalz.co/blog/the-problem-with-writing-is-thinking). It challenges you to articulate ideas coherently, highlights gaps in your logic, and develops your understanding. But to communicate with your writing, you need to make it reader-centric.
...
When you sit down to [finalize your title](https://www.animalz.co/blog/blog-post-titles), brainstorm multiple options using different approaches:
...
- **Reverse expectations:** Take a truism and flip it (" [You're a Content Marketer, Not a Writer](https://www.animalz.co/blog/youre-a-content-marketer-not-a-writer/)").
...
AI has exposed the cheapness of content that was always cheap — [copycat content](https://www.animalz.co/blog/copycat-content). After all, both human and machine can aggregate what already exists into a passable facsimile. One just does it faster. But that's not what makes good content.
...
_\*Georg Hegel was a 19th-century German philosopher who developed the thesis-antithesis-synthesis framework. In this framework, "thesis" refers to the conventional wisdom (often what you're arguing against), while "synthesis" is your actual argument. Yes, this is confusing since we know "thesis" to mean "your main point."_
